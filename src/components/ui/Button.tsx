...
export default function Button({
  ...
  return (
    ...
    >
      {loading ? (
        <ActivityIndicator size="small" color={variant === 'primary' ? tokens.colors.background : tokens.colors.accent} />
      ) : (
...
const styles = StyleSheet.create({
  ...
  primaryText: {
    color: tokens.colors.background, // Dark background contrast
  },
  secondaryText: {
